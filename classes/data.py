...
class Data():
    ...
    def __init__(self):
        ...
        self.output_location = 'temp_results'
        ...
        ## General admission number correction
        self.admission_number_correction_factor = 1.0
        ...
        if assess_best_outcome_without_diagnostic:
            ...
            self.diagnostic_prop_negative = 0
        ...
        self.apply_pareto_to_starting_population = True
    ...
    def load_data(self):
        ...
        self.admissions *= self.admission_number_correction_factor
